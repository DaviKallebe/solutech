...
public class PedidoListagemAdapter extends RecyclerView.Adapter<PedidoListagemAdapter.CustomViewHolder> {

    private List<Hospedagem> hospedagens;
    private Context context;
    private OnItemClicked onClick;

    public PedidoListagemAdapter(List<Hospedagem> hospedagens, Context context, OnItemClicked onClick) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View rootView = LayoutInflater.from(context).inflate(
                R.layout.fragment_pedido_listagem_recycler, parent, false);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public CustomViewHolder(View itemView) {
            ...
            perfil = itemView.findViewById(R.id.fragmento_pedido_perfil);
            nome = itemView.findViewById(R.id.fragmento_pedido_nome);
            status = itemView.findViewById(R.id.fragmento_pedido_status);
            intervalo = itemView.findViewById(R.id.fragmento_pedido_intervalo);
